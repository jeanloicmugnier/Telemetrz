...
public class ViewPager extends ViewGroup {
    ...
    public static class SavedState extends BaseSavedState {
        ...
        static class C01671 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C01671() {
            }
    ...
    class MyAccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            if (event.getEventType() == DfuSettingsConstants.SETTINGS_DEFAULT_MBR_SIZE && ViewPager.this.mAdapter != null) {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            if (ViewPager.this.canScrollHorizontally(ViewPager.SCROLL_STATE_DRAGGING)) {
                info.addAction(DfuSettingsConstants.SETTINGS_DEFAULT_MBR_SIZE);
            }
            if (ViewPager.this.canScrollHorizontally(ViewPager.INVALID_POINTER)) {
                info.addAction(DfuBaseService.ERROR_REMOTE_MASK);
            }
        }
    ...
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent event) {
        if (event.getEventType() == DfuSettingsConstants.SETTINGS_DEFAULT_MBR_SIZE) {
