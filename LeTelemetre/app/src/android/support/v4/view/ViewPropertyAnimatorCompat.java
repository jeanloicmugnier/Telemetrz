...
public class ViewPropertyAnimatorCompat {
    ...
    static class BaseViewPropertyAnimatorCompatImpl implements ViewPropertyAnimatorCompatImpl {
        ...
        public void m23x(View view, float value) {
        }

        public void xBy(View view, float value) {
        }

        public void m24y(View view, float value) {
        }
    ...
    static class ICSViewPropertyAnimatorCompatImpl extends BaseViewPropertyAnimatorCompatImpl {
        ...
        class C01681 implements ViewPropertyAnimatorListener {
            final /* synthetic */ Runnable val$runnable;

            C01681(Runnable runnable) {
        ...
        class C01692 implements ViewPropertyAnimatorListener {
            final /* synthetic */ Runnable val$runnable;

            C01692(Runnable runnable) {
                this.val$runnable = runnable;
            }
        ...
        class C01703 implements ViewPropertyAnimatorListener {
        ...
        public void m25x(View view, float value) {
        ...
        public void m26y(View view, float value) {
        ...
        public void withEndAction(View view, Runnable runnable) {
            setListener(view, new C01681(runnable));
        }

        public void withStartAction(View view, Runnable runnable) {
            setListener(view, new C01692(runnable));
        }

        public void withLayer(View view) {
            setListener(view, new C01703(ViewCompat.getLayerType(view)));
        }
    }
