...
public class SwipeRefreshLayout extends ViewGroup {
    ...
    class C00511 extends Animation {
        C00511() {
        }
    ...
    class C00522 extends Animation {
        C00522() {
        }
    ...
    class C01763 extends BaseAnimationListener {
        C01763() {
            super(null);
        }
    ...
    class C01774 extends BaseAnimationListener {
        C01774() {
            super(null);
        }
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        this.mAnimateToStartPosition = new C00511();
        this.mShrinkTrigger = new C00522();
        this.mReturnToStartPositionListener = new C01763();
        this.mShrinkAnimationListener = new C01774();
        this.mReturnToStartPosition = new C00535();
        this.mCancel = new C00546();
