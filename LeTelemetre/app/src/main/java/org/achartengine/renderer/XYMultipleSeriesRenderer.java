...
public class XYMultipleSeriesRenderer extends DefaultRenderer {
    ...
    public void initAxesRange(int scales) {
        ...
        for (int i = 0; i < scales; i++) {
            this.mYLabelsColor[i] = DefaultRenderer.TEXT_COLOR;
            initAxesRangeForScale(i);
        }
    }

    public void initAxesRangeForScale(int i) {
        this.mMinX[i] = MathHelper.NULL_VALUE;
        this.mMaxX[i] = -1.7976931348623157E308d;
        this.mMinY[i] = MathHelper.NULL_VALUE;
    ...
    public boolean isMinXSet(int scale) {
        return this.mMinX[scale] != MathHelper.NULL_VALUE;
    }
    ...
    public boolean isMinYSet(int scale) {
        return this.mMinY[scale] != MathHelper.NULL_VALUE;
    }
